        ...
        <main>
            <div className="forsidebanner">
                ...
                <div className="content">
                    <h1>Surf med på den grønne bølge mod mere bæredygtigt webdesign</h1>
                    <br/>
                    <p>Hos Green Wave Design hjælper vi dig gennem processen med at gøre dit website lidt grønnere.
            ...
            <div className='flip-bøger-section'>
                <h1 className='flip-book-overskrift'>Hvordan vi arbejder med bæredygtigt webdesign</h1>
                <div className='sec1'>
                    <div className='bog1'>
                            ...
                            <div className="flip" id='p2'>
                                ...
                                <div>
                                    ...
                                    <br></br>Men her kan løsningen være at bruge en non-system font til overskrifter
                                         og en system font til brødtekster.
</p>
                            ...
                            <div className='flip' id='p3'>
                                ...
                                <br></br>
                                    ...
                                    <br></br>
                                        ...
                                        forøger energiforbruget og gør din side langsommere.
</p>
